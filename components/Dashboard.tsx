    ...
    <div className="flex-1 overflow-y-auto relative">
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="holo-card p-5 animate-fadeInUp delay-100">
          ...
          <Card className="holo-card p-5 animate-fadeInUp delay-200">
            <div className="flex items-center justify-between mb-3">
          ...
          <Card className="holo-card p-5 animate-fadeInUp delay-300">
            <div className="flex items-center justify-between mb-3">
        ...
        <div className="holo-panel p-6 animate-fadeInUp delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Button
              ...
              variant="secondary"
              className="holo-btn flex items-center gap-3 p-4 h-auto rounded-xl text-left w-full justify-start"
            >
